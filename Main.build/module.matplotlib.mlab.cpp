...
static void createModuleCodeObjects(void) {
    ...
    codeobj_064ab2b5616cd95a01e8ecdf402eee82 = MAKE_CODEOBJECT(module_filename_obj, 441, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[201], mod_consts[249], NULL, 6, 0, 0);
    ...
    codeobj_c5c0b32418498cfaba12015df4c22e62 = MAKE_CODEOBJECT(module_filename_obj, 71, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[195], mod_consts[260], NULL, 1, 0, 0);
}
...
static PyObject *impl_matplotlib$mlab$$$function__17_evaluate(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        tmp_cmp_expr_right_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_5, mod_consts[139]);
        if (tmp_cmp_expr_right_2 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_subscript_value_1 = PyTuple_New(3);
        {
            ...
            tmp_tuple_element_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_9, mod_consts[49]);
            if (tmp_tuple_element_1 == NULL) {
                assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_subscript_value_2 = PyTuple_New(3);
        {
            ...
            tmp_tuple_element_3 = LOOKUP_ATTRIBUTE(tmp_expression_value_16, mod_consts[49]);
            if (tmp_tuple_element_3 == NULL) {
                assert(ERROR_OCCURRED());
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assattr_value_3 = impl___main__$$$function__15_complex_call_helper_keywords_star_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assattr_value_4 = impl___main__$$$function__15_complex_call_helper_keywords_star_dict(dir_call_args);
        }
        if (tmp_assattr_value_4 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_assattr_value_5 = impl___main__$$$function__15_complex_call_helper_keywords_star_dict(dir_call_args);
        }
        if (tmp_assattr_value_5 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_assattr_value_6 = impl___main__$$$function__15_complex_call_helper_keywords_star_dict(dir_call_args);
        }
