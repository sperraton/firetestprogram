...
void checkModuleConstants_PIL$JpegPresets(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "PIL.JpegPresets");
}
#endif
...
PyObject *modulecode_PIL$JpegPresets(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
