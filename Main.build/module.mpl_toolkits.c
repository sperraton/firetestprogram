...
void checkModuleConstants_mpl_toolkits(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "mpl_toolkits");
}
#endif
...
PyObject *modulecode_mpl_toolkits(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    // Module code.
    {
        ...
        if (PyModule_Check(tmp_import_name_from_1)) {
            tmp_called_name_1 = IMPORT_NAME_OR_MODULE(
                ...
                (PyObject *)moduledict_mpl_toolkits,
                mod_consts[2],
                mod_consts[1]
            );
        } else {
        ...
        UPDATE_STRING_DICT1(moduledict_mpl_toolkits, (Nuitka_StringObject *)mod_consts[5], tmp_assign_source_1);
    }
