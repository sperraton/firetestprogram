...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assattr_value_3 = impl___main__$$$function__13_complex_call_helper_keywords_star_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assattr_value_4 = impl___main__$$$function__13_complex_call_helper_keywords_star_dict(dir_call_args);
        }
        if (tmp_assattr_value_4 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_assattr_value_5 = impl___main__$$$function__13_complex_call_helper_keywords_star_dict(dir_call_args);
        }
        if (tmp_assattr_value_5 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_assattr_value_6 = impl___main__$$$function__13_complex_call_helper_keywords_star_dict(dir_call_args);
        }
