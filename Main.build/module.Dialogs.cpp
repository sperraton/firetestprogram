...
PyObject *modulecode_Dialogs(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    PGO_onModuleEntered("Dialogs");
...
// Mark the execution in the "__spec__" value.
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT1(moduledict_Dialogs, (Nuitka_StringObject *)mod_consts[8], tmp_assign_source_1);
    }

    // Report to PGO about leaving the module without error.
    PGO_onModuleExit("Dialogs", false);
