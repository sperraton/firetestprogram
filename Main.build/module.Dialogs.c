...
/* The "module_Dialogs" is a Python object pointer of module type.
 *
...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("Dialogs"));
...
void checkModuleConstants_Dialogs(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "Dialogs");
}
#endif
...
PyObject *modulecode_Dialogs(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    module_Dialogs = module;
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_Dialogs);
...
// Mark the execution in the "__spec__" value.
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT1(moduledict_Dialogs, (Nuitka_StringObject *)mod_consts[5], tmp_assign_source_1);
    }
