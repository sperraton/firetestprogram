...
void checkModuleConstants_numpy$matrixlib(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "numpy.matrixlib");
}
#endif

// The module code objects.
static PyCodeObject *codeobj_3af39f2bd0eb86339e2f11622162d45c;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[27]); CHECK_OBJECT(module_filename_obj);
    codeobj_3af39f2bd0eb86339e2f11622162d45c = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[28], NULL, NULL, 0, 0, 0);
}
...
PyObject *modulecode_numpy$matrixlib(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_3af39f2bd0eb86339e2f11622162d45c;
    ...
    // Frame without reuse.
    frame_3af39f2bd0eb86339e2f11622162d45c = MAKE_MODULE_FRAME(codeobj_3af39f2bd0eb86339e2f11622162d45c, module_numpy$matrixlib);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_3af39f2bd0eb86339e2f11622162d45c);
    assert(Py_REFCNT(frame_3af39f2bd0eb86339e2f11622162d45c) == 2);
    ...
    }
    {
        ...
        tmp_assattr_name_3 = GET_STRING_DICT_VALUE(moduledict_numpy$matrixlib, (Nuitka_StringObject *)mod_consts[11]);
    ...
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_numpy$matrixlib, (Nuitka_StringObject *)mod_consts[24], tmp_assign_source_6);
    }
    {
        ...
        tmp_assign_source_7 = CALL_FUNCTION_WITH_SINGLE_ARG(tmp_called_name_3, mod_consts[25]);
    ...
    tmp_res = PyDict_DelItem((PyObject *)moduledict_numpy$matrixlib, mod_consts[24]);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_3af39f2bd0eb86339e2f11622162d45c);
#endif
    popFrameStack();

    assertFrameObject(frame_3af39f2bd0eb86339e2f11622162d45c);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_3af39f2bd0eb86339e2f11622162d45c, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_3af39f2bd0eb86339e2f11622162d45c->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_3af39f2bd0eb86339e2f11622162d45c, exception_lineno);
    }
