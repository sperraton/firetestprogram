...
/* The "module_numpy$typing$_nbit" is a Python object pointer of module type.
 *
...
PyObject *module_numpy$typing$_nbit;
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_numpy$typing$_nbit(void) {
...
function_impl_code functable_numpy$typing$_nbit[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_numpy$typing$_nbit;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_numpy$typing$_nbit) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_numpy$typing$_nbit[offset],
        code_object->co_name,
...
PyObject *modulecode_numpy$typing$_nbit(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    ...
    CHECK_OBJECT(module_numpy$typing$_nbit);

    // For deep importing of a module we need to have "__builtins__", so we set
    // it ourselves in the same way than CPython does. Note: This must be done
    // before the frame object is allocated, or else it may fail.

    if (GET_STRING_DICT_VALUE(moduledict_numpy$typing$_nbit, (Nuitka_StringObject *)const_str_plain___builtins__) == NULL) {
        ...
        UPDATE_STRING_DICT0(moduledict_numpy$typing$_nbit, (Nuitka_StringObject *)const_str_plain___builtins__, value);
    }

#if PYTHON_VERSION >= 0x300
    UPDATE_STRING_DICT0(moduledict_numpy$typing$_nbit, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type);
#endif
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_numpy$typing$_nbit, (Nuitka_StringObject *)const_str_plain___spec__, Py_None);
#else
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_numpy$typing$_nbit);
...
// Mark the execution in the "__spec__" value.
        ...
        UPDATE_STRING_DICT1(moduledict_numpy$typing$_nbit, (Nuitka_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif

    // Temp variables if any
    struct Nuitka_FrameObject *frame_f719291302b86d047f711c695b53cebb;
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT0(moduledict_numpy$typing$_nbit, (Nuitka_StringObject *)mod_consts[1], tmp_assign_source_1);
    }
    {
        PyObject *tmp_assign_source_2;
        tmp_assign_source_2 = module_filename_obj;
        UPDATE_STRING_DICT0(moduledict_numpy$typing$_nbit, (Nuitka_StringObject *)mod_consts[2], tmp_assign_source_2);
    }
    // Frame without reuse.
    frame_f719291302b86d047f711c695b53cebb = MAKE_MODULE_FRAME(codeobj_f719291302b86d047f711c695b53cebb, module_numpy$typing$_nbit);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_f719291302b86d047f711c695b53cebb);
    assert(Py_REFCNT(frame_f719291302b86d047f711c695b53cebb) == 2);
    ...
    }
    {
        ...
        UPDATE_STRING_DICT0(moduledict_numpy$typing$_nbit, (Nuitka_StringObject *)mod_consts[6], tmp_assign_source_3);
    }
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_f719291302b86d047f711c695b53cebb);
#endif
    popFrameStack();

    assertFrameObject(frame_f719291302b86d047f711c695b53cebb);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_f719291302b86d047f711c695b53cebb, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_f719291302b86d047f711c695b53cebb->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_f719291302b86d047f711c695b53cebb, exception_lineno);
    }
