...
static PyObject *impl_mpl_toolkits$mplot3d$axis3d$$$function__13_draw(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_23 = impl___main__$$$function__8_complex_call_helper_star_list(dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_dircall_arg2_2 = impl___main__$$$function__15__unpack_list(dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_dircall_arg2_3 = impl___main__$$$function__15__unpack_list(dir_call_args);
        }
...

        {
            ...
            tmp_iter_arg_5 = impl___main__$$$function__8_complex_call_helper_star_list(dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_dircall_arg2_4 = impl___main__$$$function__15__unpack_list(dir_call_args);
        }
...

        {
            ...
            tmp_iter_arg_7 = impl___main__$$$function__8_complex_call_helper_star_list(dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_dircall_arg2_5 = impl___main__$$$function__15__unpack_list(dir_call_args);
        }
...

        {
            ...
            tmp_iter_arg_8 = impl___main__$$$function__8_complex_call_helper_star_list(dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_dircall_arg2_6 = impl___main__$$$function__15__unpack_list(dir_call_args);
        }
...

        {
            ...
            tmp_iter_arg_9 = impl___main__$$$function__8_complex_call_helper_star_list(dir_call_args);
        }
...
static PyObject *impl_mpl_toolkits$mplot3d$axis3d$$$function__14_get_tightbbox(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_3 = impl___main__$$$function__15__unpack_list(dir_call_args);
        }
        if (tmp_assign_source_3 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    branch_no_7:;
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_2};
            tmp_args_element_value_14 = impl___main__$$$function__15__unpack_list(dir_call_args);
        }
