...
void checkModuleConstants_PIL$_version(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "PIL._version");
}
#endif
...
PyObject *modulecode_PIL$_version(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
